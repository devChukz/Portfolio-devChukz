...
const FeaturedProject = ({title, img, summary, link, github, type}) => {
  return(
    ...
    rounded-3xl border border-solid border-dark bg-light shadow-2xl p-6 dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
...
const Project = ({title, type, img, link, summary, github}) => {
  return (
    <article className='w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-4 relative dark:bg-dark dark:border-light xs:p-4'>
      ...
      <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
        <Layout className='pt-16'>
          <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
            <div className='col-span-12'> {/* Feature 1 */}
              <FeaturedProject 
            ...
            <div className='col-span-6 sm:col-span-12'> {/* Project 1 */}
              <Project 
            ...
            <div className='col-span-6 sm:col-span-12'> {/* Project 2 */}
              <Project 
                title="Beat-Box"
                img={project2}
            ...
            <div className='col-span-6 sm:col-span-12'> {/* Project 3 */}
              <Project 
                title="PayMe"
                img={project3}
